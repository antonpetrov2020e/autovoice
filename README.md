...
3. **Улучшает текст**: исправляет ошибки, расставляет пунктуацию, форматирует
4. **Генерирует осмысленные заголовки** на основе содержания
5. **Использует пользовательский словарь** для точной транскрипции имен и терминов
6. **Сохраняет** красиво оформленные заметки в Obsidian
